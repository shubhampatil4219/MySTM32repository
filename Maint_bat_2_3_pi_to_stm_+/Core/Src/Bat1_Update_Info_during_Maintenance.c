...
uint8_t transmit_info_to_be_updated[14];
...
//
	...
	//	uint8_t transmit_voltage[14];
		...
		transmit_info_to_be_updated[0]='1';
		transmit_info_to_be_updated[1]='M';
		transmit_info_to_be_updated[2]='U';
		transmit_info_to_be_updated[3]='P';
		transmit_info_to_be_updated[4]='V';
		transmit_info_to_be_updated[5]='T';
		transmit_info_to_be_updated[6]='S';
		transmit_info_to_be_updated[7]=rx_geninfo_voltage[1];
		transmit_info_to_be_updated[8]=rx_geninfo_voltage[0];
		transmit_info_to_be_updated[9]='V';
		transmit_info_to_be_updated[10]='T';
		transmit_info_to_be_updated[11]='U';
		transmit_info_to_be_updated[12]='P';
		transmit_info_to_be_updated[13]='E';





HAL_UART_Transmit_IT(&huart2, transmit_info_to_be_updated, 14);
...
//	uint8_t transmit_asoc[14]={'1','M','U','P','A','S','S',rx_geninfo_asoc[0] ,'A','S','E','U','P','E'};
	...
	transmit_info_to_be_updated[2]='U';
	transmit_info_to_be_updated[3]='P';
	transmit_info_to_be_updated[4]='A';
	transmit_info_to_be_updated[5]='S';
	transmit_info_to_be_updated[6]='S';
	transmit_info_to_be_updated[7]=rx_geninfo_asoc[0];
	transmit_info_to_be_updated[8]='A';
	transmit_info_to_be_updated[9]='S';
	transmit_info_to_be_updated[10]='E';
	transmit_info_to_be_updated[11]='U';
	transmit_info_to_be_updated[12]='P';
	transmit_info_to_be_updated[13]='E';
...
//
		...
		transmit_info_to_be_updated[2]='U';
		transmit_info_to_be_updated[3]='P';
		transmit_info_to_be_updated[4]='R';
		transmit_info_to_be_updated[5]='C';
		transmit_info_to_be_updated[6]='S';
		transmit_info_to_be_updated[7]=rx_geninfo_remcap[1];
		transmit_info_to_be_updated[8]=rx_geninfo_remcap[0];
		transmit_info_to_be_updated[9]='R';
...
//		rx_geninfo_voltage[1]=0;
 ...
 void update_cyclecount_during_maintenance_bat1()
 {
	 if(bat1_geninfo_cycle_flag==true)
	 {
		...
		transmit_info_to_be_updated[2]='U';
		transmit_info_to_be_updated[3]='P';
		transmit_info_to_be_updated[4]='C';
		transmit_info_to_be_updated[5]='C';
		transmit_info_to_be_updated[6]='S';
		transmit_info_to_be_updated[7]=rx_cyclecount[1];
		transmit_info_to_be_updated[8]=rx_cyclecount[0];
		transmit_info_to_be_updated[9]='C';
		transmit_info_to_be_updated[10]='C';
		transmit_info_to_be_updated[11]='U';
		transmit_info_to_be_updated[12]='P';
		transmit_info_to_be_updated[13]='E';
 ...
 void update_batstatus_during_maintenance_bat1()
 {
	 ...
	 if(bat1_geninfo_batterystatus_flag==true)
		 ...
		 bat1_geninfo_batterystatus_flag=false;
			...
			transmit_info_to_be_updated[2]='U';
			transmit_info_to_be_updated[3]='P';
			transmit_info_to_be_updated[4]='B';
			transmit_info_to_be_updated[5]='S';
			transmit_info_to_be_updated[6]='S';
			transmit_info_to_be_updated[7]=rx_batstatus[1];
			transmit_info_to_be_updated[8]=rx_batstatus[0];
			transmit_info_to_be_updated[9]='B';
...
if(bat1_geninfo_temperature_flag==true)
{
	...
	bat1_geninfo_temperature_flag=false;
		...
		uint8_t tx_temp[1]={0x08}; // Temperature
				...
				transmit_info_to_be_updated[2]='U';
				transmit_info_to_be_updated[3]='P';
				transmit_info_to_be_updated[4]='T';
				transmit_info_to_be_updated[5]='P';
				transmit_info_to_be_updated[6]='S';
				transmit_info_to_be_updated[7]=rx_temp[1];
				transmit_info_to_be_updated[8]=rx_temp[0];
				transmit_info_to_be_updated[9]='T';
				transmit_info_to_be_updated[10]='P';
				transmit_info_to_be_updated[11]='U';
				transmit_info_to_be_updated[12]='P';
				transmit_info_to_be_updated[13]='E';
