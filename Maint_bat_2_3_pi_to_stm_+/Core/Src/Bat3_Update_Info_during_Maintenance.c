...
uint8_t transmit_info_to_be_updated_bat3_maint[14];
...
// The above method of sending data to Pi didn't work properly.
		...
		transmit_info_to_be_updated_bat3_maint[0]='3';
		transmit_info_to_be_updated_bat3_maint[1]='M';
		transmit_info_to_be_updated_bat3_maint[2]='U';
		transmit_info_to_be_updated_bat3_maint[3]='P';
		transmit_info_to_be_updated_bat3_maint[4]='V';
		transmit_info_to_be_updated_bat3_maint[5]='T';
		transmit_info_to_be_updated_bat3_maint[6]='S';
		transmit_info_to_be_updated_bat3_maint[7]=rx_geninfo_voltage[1];
		transmit_info_to_be_updated_bat3_maint[8]=rx_geninfo_voltage[0];
		transmit_info_to_be_updated_bat3_maint[9]='V';
		transmit_info_to_be_updated_bat3_maint[10]='T';
		transmit_info_to_be_updated_bat3_maint[11]='U';
		transmit_info_to_be_updated_bat3_maint[12]='P';
		transmit_info_to_be_updated_bat3_maint[13]='E';





HAL_UART_Transmit_IT(&huart2, transmit_info_to_be_updated_bat3_maint, 14);
...
if(bat3_geninfo_asoc_flag==true)
{
	...
	transmit_info_to_be_updated_bat3_maint[2]='U';
	transmit_info_to_be_updated_bat3_maint[3]='P';
	transmit_info_to_be_updated_bat3_maint[4]='A';
	transmit_info_to_be_updated_bat3_maint[5]='S';
	transmit_info_to_be_updated_bat3_maint[6]='S';
	transmit_info_to_be_updated_bat3_maint[7]=rx_geninfo_asoc[0];
	transmit_info_to_be_updated_bat3_maint[8]='A';
	transmit_info_to_be_updated_bat3_maint[9]='S';
	transmit_info_to_be_updated_bat3_maint[10]='E';
	transmit_info_to_be_updated_bat3_maint[11]='U';
	transmit_info_to_be_updated_bat3_maint[12]='P';
	transmit_info_to_be_updated_bat3_maint[13]='E';
...
void update_RemCap_during_maintenance_bat3()
{
	...
	if(bat3_geninfo_remainingcapacity_flag==true)
	{
		...
		transmit_info_to_be_updated_bat3_maint[2]='U';
		transmit_info_to_be_updated_bat3_maint[3]='P';
		transmit_info_to_be_updated_bat3_maint[4]='R';
		transmit_info_to_be_updated_bat3_maint[5]='C';
		transmit_info_to_be_updated_bat3_maint[6]='S';
		transmit_info_to_be_updated_bat3_maint[7]=rx_geninfo_remcap[1];
		transmit_info_to_be_updated_bat3_maint[8]=rx_geninfo_remcap[0];
		transmit_info_to_be_updated_bat3_maint[9]='R';
...
void update_cyclecount_during_maintenance_bat3()
{
	 if(bat3_geninfo_cycle_flag==true)
	 {
		...
		transmit_info_to_be_updated_bat3_maint[2]='U';
		transmit_info_to_be_updated_bat3_maint[3]='P';
		transmit_info_to_be_updated_bat3_maint[4]='C';
		transmit_info_to_be_updated_bat3_maint[5]='C';
		transmit_info_to_be_updated_bat3_maint[6]='S';
		transmit_info_to_be_updated_bat3_maint[7]=rx_cyclecount[1];
		transmit_info_to_be_updated_bat3_maint[8]=rx_cyclecount[0];
		transmit_info_to_be_updated_bat3_maint[9]='C';
		transmit_info_to_be_updated_bat3_maint[10]='C';
		transmit_info_to_be_updated_bat3_maint[11]='U';
		transmit_info_to_be_updated_bat3_maint[12]='P';
		transmit_info_to_be_updated_bat3_maint[13]='E';
...
void update_batstatus_during_maintenance_bat3()
{
	 ...
	 if(bat3_geninfo_batterystatus_flag==true)
		 ...
		 bat3_geninfo_batterystatus_flag=false;
			...
			transmit_info_to_be_updated_bat3_maint[2]='U';
			transmit_info_to_be_updated_bat3_maint[3]='P';
			transmit_info_to_be_updated_bat3_maint[4]='B';
			transmit_info_to_be_updated_bat3_maint[5]='S';
			transmit_info_to_be_updated_bat3_maint[6]='S';
			transmit_info_to_be_updated_bat3_maint[7]=rx_batstatus[1];
			transmit_info_to_be_updated_bat3_maint[8]=rx_batstatus[0];
			transmit_info_to_be_updated_bat3_maint[9]='B';
...
if(bat3_geninfo_temperature_flag==true)
{
	...
	bat3_geninfo_temperature_flag=false;
		...
		uint8_t tx_temp[1]={0x08}; // Temperature
				...
				transmit_info_to_be_updated_bat3_maint[2]='U';
				transmit_info_to_be_updated_bat3_maint[3]='P';
				transmit_info_to_be_updated_bat3_maint[4]='T';
				transmit_info_to_be_updated_bat3_maint[5]='P';
				transmit_info_to_be_updated_bat3_maint[6]='S';
				transmit_info_to_be_updated_bat3_maint[7]=rx_temp[1];
				transmit_info_to_be_updated_bat3_maint[8]=rx_temp[0];
				transmit_info_to_be_updated_bat3_maint[9]='T';
				transmit_info_to_be_updated_bat3_maint[10]='P';
				transmit_info_to_be_updated_bat3_maint[11]='U';
				transmit_info_to_be_updated_bat3_maint[12]='P';
				transmit_info_to_be_updated_bat3_maint[13]='E';
