...
//#include "Transmit_bat1_spec_para.h"
...
//	printf("Design Capacity = %d\n",designcap);
	...
	uint8_t send_specific_design_cap2[14]={'1','M','S','I','D','C','S',rx_design_capacity2[1],rx_design_capacity2[0],'D','C','S','I','E'};
	HAL_UART_Transmit_IT(&huart2, send_specific_design_cap2, 14);
...
void Read_bat1_maint_Run_time_to_empty()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[14]={'1','M','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','F','I','E'};
...
void Read_bat1_maint_Run_time_to_empty_end_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[14]={'1','M','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','L','I','E'};
