...
void Read_and_Compare_Specific_para_Bat3_STM_to_Pi()
{
	...
	uint8_t send_specific_batstatus[14]={'3','M','S','I','B','S','S',rx_batstatus[1],rx_batstatus[0],'B','S','S','I','E'};
...
//	printf("Full Charge Capacity = %d\n",fcc);
	...
	uint8_t send_specific_fcc[14]={'3','M','S','I','F','C','S',rx_full_charge_capacity[1],rx_full_charge_capacity[0],'F','C','S','I','E'};
...
//	printf("Design Capacity = %d\n",designcap);
	...
	uint8_t send_specific_design_cap[14]={'3','M','S','I','D','C','S',rx_design_capacity[1],rx_design_capacity[0],'D','C','S','I','E'};
...
void Read_bat3_maint_Run_time_to_empty_start_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[14]={'3','M','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','F','I','E'};
...
void Read_bat3_maint_Run_time_to_empty_end_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[14]={'3','M','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','L','I','E'};
