...
void Transmit_Bat3_Maintenance_General_Info_to_Raspi()
{
	...
	// GI function starts From here
		...
		uint8_t send_serial_no[14]={'3','M','G','I','S','N','S',rx_serial_no[1],rx_serial_no[0],'S','N','G','I','E'};
		...
		//	y=y>>9;
		//	y=y+1980;
		uint8_t send_manuf_date[14]={'3','M','G','I','M','D','S',rx_manuf_date[1],rx_manuf_date[0],'M','D','G','I','E'};
		...
		uint8_t send_cyclecount[14]={'3','M','G','I','C','C','S',rx_cyclecount[1],rx_cyclecount[0],'C','C','G','I','E'};
		...
		uint8_t send_remain_capcacity[14]={'3','M','G','I','R','C','S',rx_remcapacity[1],rx_remcapacity[0],'R','C','G','I','E'};
		...
		uint8_t send[14]={'3','M','G','I','V','T','S',rx_voltage[1],rx_voltage[0],'V','T','G','I','E'};
		...
		uint8_t send_asoc[14]={'3','M','G','I','A','S','S',rx_asoc[0],'A','S','E','G','I','E'};
		...
		uint8_t send_temp[14]={'3','M','G','I','T','P','S',rx_temperature[1],rx_temperature[0],'T','P','G','I','E'};
		...
		uint8_t send_bat_status[14]={'3','M','G','I','B','S','S',rx_batstatus[1],rx_batstatus[0],'B','S','G','I','E'};
