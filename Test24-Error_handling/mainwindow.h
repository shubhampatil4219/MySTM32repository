...
private slots:
    ...
    void on_Bat1EnterMaint_button_clicked();
        ...
        void on_Test_report_bat2_clicked();

        void on_Test_report_bat3_clicked();
...
// Following are the slots when Bat3 General Info (GI) is received during Maintenance Use Case



 void Receive_battery3_MaintGI_serial_no(int);
 void Receive_battery3_MaintGI_manuf_date(int);
 void Receive_battery3_MaintGI_cyclecount(int);
 void Receive_battery3_MaintGI_RemCap(int);
 void Receive_battery3_MaintGI_asoc(int);
 void Receive_battery3_MaintGI_voltage(int);
 void Receive_battery3_MaintGI_temperature(float);
 void Receive_battery3_MaintGI_batstatus(int);


 // Following are the slots when Bat3 Specific Info is received during Maintenance Use Case

void Receive_battery3_Maint_SpecificInfo_batstatus(int);
void Receive_battery3_Maint_SpecificInfo_fullchargecapacity(int);
void Receive_battery3_Maint_SpecificInfo_designcapacity(int);
void Receive_battery3_Maint_SpecificInfo_run_time_to_empty(int);
void Receive_battery3_Maint_SpecificInfo_run_time_to_empty_end_of_discharge(int);


// Following are the slots to dislplay Bat 3 Maintenance Use Case Results on GUI
void Receive_battery3_Maint_f80_voltage(int);
void Receive_battery3_Maint_f80_asoc(int);
void Receive_battery3_Maint_f80_remcap(int);
void Receive_battery3_Maint_f80_cycount(int);
void Receive_battery3_Maint_f80_batstatus(int);
void Receive_battery3_Maint_f80_temperature(float);


void Receive_battery3_Maint_m10_voltage(int);
void Receive_battery3_Maint_m10_asoc(int);
void Receive_battery3_Maint_m10_remcap(int);
void Receive_battery3_Maint_m10_cycount(int);
void Receive_battery3_Maint_m10_batstatus(int);
void Receive_battery3_Maint_m10_temperature(float);

void Receive_battery3_Maint_l80_voltage(int);
void Receive_battery3_Maint_l80_asoc(int);
void Receive_battery3_Maint_l80_remcap(int);
void Receive_battery3_Maint_l80_cycount(int);
void Receive_battery3_Maint_l80_batstatus(int);
void Receive_battery3_Maint_l80_temperature(float);


// Following are the slots when bat 3 updated info is received
// during maintenance use case

void bat3_update_voltage_maint_read(int);
void bat3_update_asoc_maint_read(int);
void bat3_update_temp_maint_read(float);
void bat3_update_cyclecount_maint_read(int);
void bat3_update_remcap_maint_read(int);
void bat3_update_batstatus_maint_read(int);


// Functions to Interpret the Results of bat 3 Maintenance Use Case
void Battery3_Result_Maint_Interpret_Voltage();
void Battery3_Result_Maint_Interpret_Temperature();
void Battery3_Result_Maint_Interpret_CycleCount();
void Battery3_Result_Maint_Interpret_Remaining_capacity();
void Battery3_Result_Maint_Interpret_asoc();
void Battery3_Result_Maint_Interpret_battery_status();

// Function to Interpret Bat 3 Maintenance Use case Specific Info - Run time to empty
void Battery3_Maint_Specific_Info_Interpret_RTE();
...
int Interpret_specific_Info_maint_bat1[2];
...
// Following variables are defined for Interpretation
// of Bat 3 Maintenance Parameters

int Interpret_b3m_result_f80[5];
int Interpret_b3m_result_m10[5];
int Interpret_b3m_result_l80[5];

float Interpret_b3m_temperature[3];

int Interpret_b3m_rte[2];

int Interpret_specific_Info_maint_bat3[2];
