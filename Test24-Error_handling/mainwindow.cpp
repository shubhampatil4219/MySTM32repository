...
//    connect(worker,SIGNAL(bat1_maint_last80(int,int,int,int,int,int)),this,SLOT(onbat1_maint_last80(int,int,int,int,int,int)));
  ...
  connect(process,SIGNAL(send_bat2_update_voltage_maint(int)),this,SLOT(bat2_update_voltage_maint_read(int)));
   ...
   // Following are the connections when Bat3 General Info is received during Maintenance Use Case
   connect(process,SIGNAL(send_battery3_MaintGI_voltage(int)),this,SLOT(Receive_battery3_MaintGI_voltage(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_serial_no(int)),this,SLOT(Receive_battery3_MaintGI_serial_no(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_manuf_date(int)),this,SLOT(Receive_battery3_MaintGI_manuf_date(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_cyclecount(int)),this,SLOT(Receive_battery3_MaintGI_cyclecount(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_RemCap(int)),this,SLOT(Receive_battery3_MaintGI_RemCap(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_asoc(int)),this,SLOT(Receive_battery3_MaintGI_asoc(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_batstatus(int)),this,SLOT(Receive_battery3_MaintGI_batstatus(int)));
   connect(process,SIGNAL(send_battery3_MaintGI_temperature(float)),this,SLOT(Receive_battery3_MaintGI_temperature(float)));


   // Following are the connections when Bat3 Specific Info is received during Maintenance Use Case

  connect(process,SIGNAL(send_battery3_Maint_SpecificInfo_batstatus(int)),this,SLOT(Receive_battery3_Maint_SpecificInfo_batstatus(int)));
  connect(process,SIGNAL(send_battery3_Maint_SpecificInfo_fullchargecapacity(int)),this,SLOT(Receive_battery3_Maint_SpecificInfo_fullchargecapacity(int)));
  connect(process,SIGNAL(send_battery3_Maint_SpecificInfo_designcapacity(int)),this,SLOT(Receive_battery3_Maint_SpecificInfo_designcapacity(int)));
  connect(process,SIGNAL(send_battery3_Maint_SpecificInfo_run_time_to_empty(int)),this,SLOT(Receive_battery3_Maint_SpecificInfo_run_time_to_empty(int)));
  connect(process,SIGNAL(send_battery3_Maint_SpecificInfo_run_time_to_empty_end_of_discharge(int)),this,SLOT(Receive_battery3_Maint_SpecificInfo_run_time_to_empty_end_of_discharge(int)));



  // Following are the connections when Bat 3 results are received during Maintenance Use Case

 connect(process,SIGNAL(send_battery3_Maint_f80_voltage(int)),this,SLOT(Receive_battery3_Maint_f80_voltage(int)));
 connect(process,SIGNAL(send_battery3_Maint_f80_asoc(int)),this,SLOT(Receive_battery3_Maint_f80_asoc(int)));
 connect(process,SIGNAL(send_battery3_Maint_f80_remcap(int)),this,SLOT(Receive_battery3_Maint_f80_remcap(int)));
 connect(process,SIGNAL(send_battery3_Maint_f80_cycount(int)),this,SLOT(Receive_battery3_Maint_f80_cycount(int)));
 connect(process,SIGNAL(send_battery3_Maint_f80_batstatus(int)),this,SLOT(Receive_battery3_Maint_f80_batstatus(int)));
 connect(process,SIGNAL(send_battery3_Maint_f80_temperature(float)),this,SLOT(Receive_battery3_Maint_f80_temperature(float)));



 connect(process,SIGNAL(send_battery3_Maint_m10_voltage(int)),this,SLOT(Receive_battery3_Maint_m10_voltage(int)));
 connect(process,SIGNAL(send_battery3_Maint_m10_asoc(int)),this,SLOT(Receive_battery3_Maint_m10_asoc(int)));
 connect(process,SIGNAL(send_battery3_Maint_m10_remcap(int)),this,SLOT(Receive_battery3_Maint_m10_remcap(int)));
 connect(process,SIGNAL(send_battery3_Maint_m10_cycount(int)),this,SLOT(Receive_battery3_Maint_m10_cycount(int)));
 connect(process,SIGNAL(send_battery3_Maint_m10_batstatus(int)),this,SLOT(Receive_battery3_Maint_m10_batstatus(int)));
 connect(process,SIGNAL(send_battery3_Maint_m10_temperature(float)),this,SLOT(Receive_battery3_Maint_m10_temperature(float)));


 connect(process,SIGNAL(send_battery3_Maint_l80_voltage(int)),this,SLOT(Receive_battery3_Maint_l80_voltage(int)));
 connect(process,SIGNAL(send_battery3_Maint_l80_asoc(int)),this,SLOT(Receive_battery3_Maint_l80_asoc(int)));
 connect(process,SIGNAL(send_battery3_Maint_l80_remcap(int)),this,SLOT(Receive_battery3_Maint_l80_remcap(int)));
 connect(process,SIGNAL(send_battery3_Maint_l80_cycount(int)),this,SLOT(Receive_battery3_Maint_l80_cycount(int)));
 connect(process,SIGNAL(send_battery3_Maint_l80_batstatus(int)),this,SLOT(Receive_battery3_Maint_l80_batstatus(int)));
 connect(process,SIGNAL(send_battery3_Maint_l80_temperature(float)),this,SLOT(Receive_battery3_Maint_l80_temperature(float)));


 // Following are the connections when bat3 updated info is received

 connect(process,SIGNAL(send_bat3_update_voltage_maint(int)),this,SLOT(bat3_update_voltage_maint_read(int)));
 connect(process,SIGNAL(send_bat3_update_asoc_maint(int)),this,SLOT(bat3_update_asoc_maint_read(int)));
 connect(process,SIGNAL(send_bat3_update_temp_maint(float)),this,SLOT(bat3_update_temp_maint_read(float)));
 connect(process,SIGNAL(send_bat3_update_cyccount_maint(int)),this,SLOT(bat3_update_cyclecount_maint_read(int)));
 connect(process,SIGNAL(send_bat3_update_remcap_maint(int)),this,SLOT(bat3_update_remcap_maint_read(int)));
 connect(process,SIGNAL(send_bat3_update_batstatus_maint(int)),this,SLOT(bat3_update_batstatus_maint_read(int)));
...
ui->comboBox->addItem("Bat1");
ui->comboBox->addItem("Bat2");
ui->comboBox->addItem("Bat3");
...
// Following are the slots when Bat3 General Info is received during Maintenance Use Case

void MainWindow::Receive_battery3_MaintGI_serial_no(int serialno)
{
   QFile file("Bat3_Maint_log_file.txt"); //
   ...
   QTextStream stream(&file);
 //  stream<<"\t\t\t\t\t\tLog File\n\n";
   stream<<"\t\t\t\t\t\t BATTERY 3 MAINTENANCE USE CASE REPORT \n";
   stream<<"->Battery 3 Maintenance Use Case general info\n\n";
   stream<<"Serial No:"<<QString::number(serialno)<<"\n";
   stream<<"Manufacturer Name: LS Telcom AG \n";
   file.flush();
   file.close();

   qDebug()<<"Bat 3 from mainwindow GI Serial No received ="<<serialno;
//ui->Bat1_Maint_GI_SN->setText(QString::number(serialno));

//ui->Bat1_Maint_GI_MN->setText("LS Telcom AG");
}

void MainWindow::Receive_battery3_MaintGI_manuf_date(int mandate)
{
...
year = year>>9;
year=year+1980;
 qDebug()<<" Bat 3 from mainwindow GI manuf date received ="<<mandate;
//ui->Bat1_Maint_GI_MD->setText(QString::number(date)+"."+QString::number(month)+"."+QString::number(year));
...
void MainWindow::Receive_battery3_MaintGI_cyclecount(int ccount)
{
...
file.flush();
file.close();
qDebug()<<" Bat 3 from mainwidnow GI cycle count received ="<<ccount;
}

void MainWindow::Receive_battery3_MaintGI_RemCap(int remcap)
{
   //ui->Bat1_Maint_GI_RC->setText(QString::number(remcap));
   QFile file("Bat3_Maint_log_file.txt");
   file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
   ...
   file.close();
    ...
    qDebug()<<" Bat 3 from mainwidnow GI Rem Cap received ="<<remcap;
}

void MainWindow::Receive_battery3_MaintGI_asoc(int asoc)
{
   //ui->Bat1_Maint_GI_ASOC->setText(QString::number(asoc));
    QFile file("Bat3_Maint_log_file.txt");
   file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
   ...
   file.flush();
   file.close();
    qDebug()<<"Bat 3 from mainwindow GI Asoc received="<<asoc;

}



void MainWindow::Receive_battery3_MaintGI_voltage(int voltage)
{
//ui->Bat1_Maint_GI_Volt->setText(QString::number(voltage));
 QFile file("Bat3_Maint_log_file.txt");
file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
...
file.flush();
file.close();
qDebug()<<"Bat 3 from mainwidnow GI Voltage  Received="<<voltage; // This function works
}

void MainWindow::Receive_battery3_MaintGI_batstatus(int bat_status)
{

    qDebug()<<" Bat 3 from mainwidnow GI Batstatus received ="<<bat_status;
...
void MainWindow::Receive_battery3_MaintGI_temperature(float temp)
{
float temperature =static_cast<float>(((temp/10.0)-273.15));
//ui->Bat1_Maint_GI_Temp->setText(QString::number(temperature));
 QFile file("Bat3_Maint_log_file.txt");
...
qDebug()<<"Bat 3 from mainwindow GI temperature received"<<temperature;
}



// Following are the slots when Bat3 Specific Info is received during Maintenance Use Case

void MainWindow::Receive_battery3_Maint_SpecificInfo_batstatus(int bat_status)
{

    qDebug()<<"Bat3 from mainwindow Specific info batstatus"<<bat_status; // Works
    uint8_t batterystatusarray_update[16];
    QFile file("Bat3_Maint_log_file.txt");
    file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
    QTextStream stream(&file);
    stream<<"->Battery 3 Maintenance Use Case Specific Info\n\n";
    stream<<"Battery Status: \n";
    if(0<= bat_status && bat_status<=65535)
    {
        for (int j=0;j<16;j++) {
...
void MainWindow::Receive_battery3_Maint_SpecificInfo_fullchargecapacity(int fullchargecap)
{
    //ui->Bat1_Maint_SPCI_FCC->setText(QString::number(fullchargecap));


    Interpret_specific_Info_maint_bat3[0]=fullchargecap;
    //qDebug()<<"This is pointer fcc"<<Interpret_specific_Info_maint_bat1[0];
    ...
    qDebug()<<"Bat 3 from mainwindow Full charge specific info received"<<fullchargecap;
}

void MainWindow::Receive_battery3_Maint_SpecificInfo_designcapacity(int designcap)
{
    //ui->Bat1_Maint_SPCI_DC->setText(QString::number(designcap));


    Interpret_specific_Info_maint_bat3[1]=designcap;
    //qDebug()<<"This is pointer dc"<<Interpret_specific_Info_maint_bat1[1];
    int fcc=Interpret_specific_Info_maint_bat3[0];
    int dc=Interpret_specific_Info_maint_bat3[1];
    if(fcc>4620 && fcc<dc)
    {
...
//
    ...
    file.close();
     ...
     qDebug()<<"Bat 3 from mainwindow design capacity specific info received"<<designcap;

}

void MainWindow::Receive_battery3_Maint_SpecificInfo_run_time_to_empty(int rte)
{



qDebug()<<"Bat3 from mainwindow RTE start specific info received="<<QString::number(rte);
//ui->Bat_Maint_SPCI_RTE_10S->setText(QString::number(rte));// Works

Interpret_b3m_rte[0]=rte;
...
void MainWindow::Receive_battery3_Maint_SpecificInfo_run_time_to_empty_end_of_discharge(int rte)
{


//    ui->Bat_Maint_SPCI_RTE_10E->setText(QString::number(rte));

    Interpret_b3m_rte[1]=rte;

    Battery3_Maint_Specific_Info_Interpret_RTE();
    ...
    qDebug()<<"Bat3 from mainwindow RTE end specific info received="<<QString::number(rte);
}


// Following are the slots when Bat3 Maintenance Use Case results are received


// Results bat 3 Maint charged to 80 %
void MainWindow::Receive_battery3_Maint_f80_voltage(int voltage)
{
    //ui->bat1_maint_result_f80_vt->setText(QString::number(voltage));
    QFile file("Bat3_Maint_log_file.txt");
    file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
    ...
    Interpret_b3m_result_f80[3]=voltage;
   // qDebug()<< "f80 pos 3 voltage"<<Interpret_b1m_result_f80[3];

  qDebug()<<" Bat 3 from mainwindow F80 Voltage  Received="<<voltage;


}
void MainWindow:: Receive_battery3_Maint_f80_asoc(int asoc)
{
 //ui->bat1_maint_result_f80_asoc->setText(QString::number(asoc));
 ...
 Interpret_b3m_result_f80[2]=asoc;
// qDebug()<< "f80 pos 2 asoc"<<Interpret_b1m_result_f80[2];
 qDebug()<<"Bat 3 from mainwindow F80 Asoc received="<<asoc;

}
void MainWindow:: Receive_battery3_Maint_f80_remcap(int remcap)
{
   //ui->bat1_maint_result_f80_remcap->setText(QString::number(remcap));
   QFile file("Bat3_Maint_log_file.txt");
   file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
   ...
   Interpret_b3m_result_f80[1]=remcap;
  // qDebug()<< "f80 pos 1 remcap"<<Interpret_b1m_result_f80[1];
   qDebug()<<" Bat 3 from mainwindowF80 Rem Cap received ="<<remcap;

}
void MainWindow:: Receive_battery3_Maint_f80_cycount(int cyclecount)
{
  // ui->bat1_maint_result_f80_cyclecount->setText(QString::number(cyclecount));
  QFile file("Bat3_Maint_log_file.txt");
   file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
   ...
   Interpret_b3m_result_f80[0]=cyclecount;
   //qDebug()<< "f80 pos 0 cyc"<<Interpret_b1m_result_f80[0];
   qDebug()<<" \nBat 3 from mainwindow F80 cycle count received ="<<cyclecount;



}
void MainWindow:: Receive_battery3_Maint_f80_batstatus(int batstatus)
{
    uint8_t batterystatusarray[16];

    qDebug()<<" Bat 3 from mainwindow F80  Batstatus received ="<<batstatus;


    Interpret_b3m_result_f80[4]=batstatus;
   // qDebug()<< "f80 pos 4 batstatus"<<Interpret_b1m_result_f80[4];
...
void MainWindow::Receive_battery3_Maint_f80_temperature(float temp)
{
        float temperature =static_cast<float>(((temp/10.0)-273.15));
   // ui->bat1_maint_result_f80_temp->setText(QString::number(temperature));
    QFile file("Bat3_Maint_log_file.txt");
    ...
    Interpret_b3m_temperature[0]=temperature;

    qDebug()<<" Bat 3 from mainwindow F80 Temperature received ="<<temperature;
...
// Results bat 3 Maint discharged to 10 %

void MainWindow::Receive_battery3_Maint_m10_voltage(int voltage)
{
        //ui->bat1_maint_result_m80_vt->setText(QString::number(voltage));
        QFile file("Bat3_Maint_log_file.txt");
        file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
        ...
        Interpret_b3m_result_m10[3]=voltage;
        qDebug()<<" Bat 3 from mainwindow M10 Voltage  Received="<<voltage;

}

void MainWindow::Receive_battery3_Maint_m10_asoc(int asoc)
{
    //ui->bat1_maint_result_m80_asoc->setText(QString::number(asoc));
    QFile file("Bat3_Maint_log_file.txt");
    file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
    ...
    Interpret_b3m_result_m10[2]=asoc;
    qDebug()<<"Bat 3 from mainwindow M10 Asoc received="<<asoc;
}

void MainWindow::Receive_battery3_Maint_m10_remcap(int remcap)
{
    //ui->bat1_maint_result_m80_remcap->setText(QString::number(remcap));
     QFile file("Bat3_Maint_log_file.txt");
    file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
    ...
    Interpret_b3m_result_m10[1]=remcap;

    qDebug()<<" Bat 3 from mainwindow M10 Rem Cap received ="<<remcap;
}
void MainWindow::Receive_battery3_Maint_m10_cycount(int cycount)
{
    //ui->bat1_maint_result_m80_cyclecount->setText(QString::number(cycount));
    QFile file("Bat3_Maint_log_file.txt");
    file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
    ...
    file.flush();
    file.close();
    Interpret_b3m_result_m10[0]=cycount;

    qDebug()<<" \n Bat 3 from mainwindow M10 cycle count received ="<<cycount;
}

void MainWindow::Receive_battery3_Maint_m10_batstatus(int batstatus)
{

     qDebug()<<" Bat 3 from mainwindow M10 Batstatus received ="<<batstatus;
        uint8_t batterystatusarray[16];

        Interpret_b3m_result_m10[4]=batstatus;
...
void MainWindow::Receive_battery3_Maint_m10_temperature(float temp)
{
    float temperature =static_cast<float>(((temp/10.0)-273.15));
    //ui->bat1_maint_result_m80_temp->setText(QString::number(temperature));
    QFile file("Bat3_Maint_log_file.txt");
    ...
    Interpret_b3m_temperature[1]=temperature;

    qDebug()<<" Bat 3 from mainwindow M10 Temperature received ="<<temperature;


}

// Results bat 3 Maint Recharged to 80 %

void MainWindow::Receive_battery3_Maint_l80_voltage(int voltage)
{
      ...
      Interpret_b3m_result_l80[3]=voltage;

       qDebug()<<" Bat 3 from mainwindow L80 Voltage  Received="<<voltage;


}
void MainWindow::Receive_battery3_Maint_l80_asoc(int asoc)
{
     //ui->bat1_maint_result_l80_asoc->setText(QString::number(asoc));
     QFile file("Bat3_Maint_log_file.txt");
     file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
     ...
     Interpret_b3m_result_l80[2]=asoc;

     qDebug()<<"Bat 3 from mainwindow L80 Asoc received="<<asoc;

}


void MainWindow::Receive_battery3_Maint_l80_remcap(int remcap)
{
    // ui->bat1_maint_result_l80_rempcap->setText(QString::number(remcap));
     QFile file("Bat3_Maint_log_file.txt");
     file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
     ...
     Interpret_b3m_result_l80[1]=remcap;

     qDebug()<<" Bat 3 from mainwindow L80 Rem Cap received ="<<remcap;
}


void MainWindow::Receive_battery3_Maint_l80_cycount(int cycount)
{
   //ui->bat1_maint_result_l80_cyclecount->setText(QString::number(cycount));
   QFile file("Bat3_Maint_log_file.txt");
   file.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
   ...
   Interpret_b3m_result_l80[0]=cycount;

   qDebug()<<" \nBat 3 from mainwindow L80 cycle count received ="<<cycount;

}
void MainWindow::Receive_battery3_Maint_l80_batstatus(int batstatus)
{

    qDebug()<<" Bat 3 from mainwindow L80  Batstatus received ="<<batstatus;
        uint8_t batterystatusarray[16];

        Interpret_b3m_result_l80[4]=batstatus;
        ...
        Battery3_Result_Maint_Interpret_Voltage();
        Battery3_Result_Maint_Interpret_Temperature();
        Battery3_Result_Maint_Interpret_CycleCount();
        Battery3_Result_Maint_Interpret_Remaining_capacity();
        Battery3_Result_Maint_Interpret_asoc();
        Battery3_Result_Maint_Interpret_battery_status();


}
void MainWindow::Receive_battery3_Maint_l80_temperature(float temp)
{
        float temperature =static_cast<float>(((temp/10.0)-273.15));
      //  ui->bat1_maint_result_l80_temp->setText(QString::number(temperature));
       QFile file("Bat3_Maint_log_file.txt");
        ...
        Interpret_b3m_temperature[2]=temperature;

        qDebug()<<" Bat 3 from mainwindow L80 Temperature received ="<<temperature;
...
// Following are the slots when Bat3 Update Info is received during Maintenance Use Case

void MainWindow::bat3_update_voltage_maint_read(int volt)
{
   // ui->Bat1_Maint_GI_Volt->setText(QString::number(volt));

    qDebug()<<" Bat3 from mainwindow updated voltage received"<<volt;
}

void MainWindow::bat3_update_asoc_maint_read(int asoc)
{
//        ui->Bat1_Maint_GI_ASOC->setText(QString::number(asoc));
//         ui->progressBar->setValue(asoc);

    qDebug()<<"Bat3 from mainwindow Updated ASOC  Received="<<asoc;
}


void MainWindow::bat3_update_temp_maint_read(float temp)
{
//ui->Bat1_Maint_GI_Temp->setText(QString::number(temp));

   qDebug()<<"Bat3 from mainwindow Updated temp  Received="<<temp;
}

void MainWindow::bat3_update_remcap_maint_read(int rcap)
{
//ui->Bat1_Maint_GI_RC->setText(QString::number(rcap));

    qDebug()<<"Bat3 from mainwindow Updated rem cap  Received="<<rcap;
}

void MainWindow::bat3_update_cyclecount_maint_read(int count)
{
//ui->Bat1_Maint_GI_CC->setText(QString::number(count));

    qDebug()<<"Bat3 from mainwindow Updated cycle count  Received="<<count;
}
...
void MainWindow::bat3_update_batstatus_maint_read(int bat_status)
{
//ui->Bat1_Maint_GI_BS_bit15to11->setText(QString::number(bat_status));
//qDebug()<< "Entered BS function";
//qDebug()<<bat_status;   // Works properly

    qDebug()<<"Bat3 from mainwindow Updated batstatus  Received="<<bat_status;
...
// Following are the slots to interpret bat 3 maintenance use case parameters

void MainWindow::Battery3_Result_Maint_Interpret_Voltage()
{


int voltage_f80= Interpret_b3m_result_f80[3];
int voltage_m10= Interpret_b3m_result_m10[3];
int voltage_l80= Interpret_b3m_result_l80[3];
...
void MainWindow::Battery3_Result_Maint_Interpret_Temperature() // This function is to interpret bat 1 maint result - temperature
{
float temp_f80=Interpret_b3m_temperature[0];
float temp_m10=Interpret_b3m_temperature[1];
float temp_l80=Interpret_b3m_temperature[2];
...
void MainWindow::Battery3_Result_Maint_Interpret_CycleCount()
{
    int cyc_f80=Interpret_b3m_result_f80[0];
    int cyc_m10=Interpret_b3m_result_m10[0];
    int cyc_l80=Interpret_b3m_result_l80[0];
...
void MainWindow::Battery3_Result_Maint_Interpret_Remaining_capacity()
{

int remcap_f80= Interpret_b3m_result_f80[1];
int remcap_m10= Interpret_b3m_result_m10[1];
int remcap_l80= Interpret_b3m_result_l80[1];
...
void MainWindow::Battery3_Result_Maint_Interpret_asoc()
{

int asoc_f80=Interpret_b3m_result_f80[2];
int asoc_m10=Interpret_b3m_result_m10[2];
int asoc_l80=Interpret_b3m_result_l80[2];
...
void MainWindow:: Battery3_Result_Maint_Interpret_battery_status()
{

int batstatus_f80=Interpret_b3m_result_f80[4];
int batstatus_m10=Interpret_b3m_result_m10[4];
int batstatus_l80=Interpret_b3m_result_l80[4];
...
void MainWindow::Battery3_Maint_Specific_Info_Interpret_RTE()
{
    int rte1,rte2;
    rte1=Interpret_b3m_rte[0];
    rte2=Interpret_b3m_rte[1];
...
//void MainWindow::on_Test_report_bat2_button_clicked()
//{
//    QFile logfile_bat2_maint("Bat2_Maint_log_file.txt");
//    logfile_bat2_maint.open(QFile::ReadOnly);
//    QTextStream stream(&logfile_bat2_maint);
//    while(!stream.atEnd()){

//        QString line = stream.readAll();
//        logfile_bat2_maint.close();

//        QFileDialog dialog;
//        dialog.setFileMode(QFileDialog::AnyFile);
//        QString reportFile_bat2_maint=dialog.getSaveFileName(NULL,"create New file","","");
//        QFile report_bat2_maint(reportFile_bat2_maint);
//        report_bat2_maint.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
//        QTextStream stream2(&report_bat2_maint);
//       // stream2<<"\t\t\t\t\t\t BATTERY 1 MAINTENANCE USE CASE REPORT \n";
//        stream2<<line;
//        report_bat2_maint.flush();
//        qDebug()<<line;
...
//void MainWindow::on_Test_report_bat2_button_clicked()
//{
//    QFile logfile_bat3_maint("Bat3_Maint_log_file.txt");
//    logfile_bat3_maint.open(QFile::ReadOnly);
//    QTextStream stream(&logfile_bat3_maint);
//    while(!stream.atEnd()){

//        QString line = stream.readAll();
//        logfile_bat3_maint.close();

//        QFileDialog dialog;
//        dialog.setFileMode(QFileDialog::AnyFile);
//        QString reportFile_bat3_maint=dialog.getSaveFileName(NULL,"create New file","","");
//        QFile report_bat3_maint(reportFile_bat3_maint);
//        report_bat3_maint.open(QFile::WriteOnly | QFile::Text |QIODevice::Append);
//        QTextStream stream2(&report_bat3_maint);
//       // stream2<<"\t\t\t\t\t\t BATTERY 1 MAINTENANCE USE CASE REPORT \n";
//        stream2<<line;
//        report_bat3_maint.flush();
//        qDebug()<<line;
...
void MainWindow::on_Test_report_bat2_clicked()
{
...
void MainWindow::on_Test_report_bat3_clicked()
{
        QFile logfile_bat3_maint("Bat3_Maint_log_file.txt");
        logfile_bat3_maint.open(QFile::ReadOnly);
        QTextStream stream(&logfile_bat3_maint);
