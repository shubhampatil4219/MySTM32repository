...
void data_process::data_from_worker(QByteArray rx)
{
    ...
    //    qDebug()<<"buffer from data process"<<rx;
   //     qDebug()<<rx.size();
//        qDebug()<<rx.at(0);
   ...
   //     qDebug()<<"Bat 2 design capacity specific info received"<<design_cap;
    ...
    // general information
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         L=rx[8];
         v=((M<<8)+L);
       emit send_battery3_MaintGI_voltage(v);
             ...
             && rx[11]=='G' && rx[12]=='I' && rx[13]=='E')
     {
         ...
         int asoc;
         asoc=rx[7];
         emit send_battery3_MaintGI_asoc(asoc);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         quint8 sern2=rx[8];
         int sernum=((sern1<<8)+sern2);
         emit send_battery3_MaintGI_serial_no(sernum);
...
//         qDebug()<<month;
//         qDebug()<<year;
         emit send_battery3_MaintGI_manuf_date(manuf_date);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         int ccount;
         ccount=((ccc1<<8)+ccc2);
         emit send_battery3_MaintGI_cyclecount(ccount);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         quint8 rcc2=rx[8];
         int remcapac=((rcc1<<8)+rcc2);
         emit send_battery3_MaintGI_RemCap(remcapac);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
                        ...
                        float temperature=((temp1<<8)+temp2);
                        float temperatureGI =static_cast<float>(((temperature/10.0)-273.15));
                        emit send_battery3_MaintGI_temperature(temperature);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
                         ...
                         quint8 bs2=rx[8];
                         int bstatus=((bs1<<8)+bs2);
                         emit send_battery3_MaintGI_batstatus(bstatus);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         emit send_battery3_Maint_SpecificInfo_batstatus(bstatus);
    ...
    emit send_battery3_Maint_SpecificInfo_designcapacity(design_cap);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         quint8 fcc2=rx[8];
         int fcc=((fcc1<<8)+fcc2);
        emit send_battery3_Maint_SpecificInfo_fullchargecapacity(fcc);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         quint8 rte2=rx[8];
         int rte=((rte1<<8)+rte2);
         emit send_battery3_Maint_SpecificInfo_run_time_to_empty(rte);
             ...
             && rx[12]=='I' && rx[13]=='E')
     {
         ...
         quint8 rte2=rx[8];
         int rte=((rte1<<8)+rte2);
         emit send_battery3_Maint_SpecificInfo_run_time_to_empty_end_of_discharge(rte);
             ...
             && rx[12]=='N' && rx[13]=='D')  // Result bat 3 F80 Voltage
     {
         ...
         L=rx[8];
         v=((M<<8)+L);
        emit send_battery3_Maint_f80_voltage(v);
             ...
             && rx[11]=='E' && rx[12]=='N' && rx[13]=='D') // Bat 3 Result F80 ASOC
     {
         ...
         int asoc;
         asoc=rx[7];
         emit send_battery3_Maint_f80_asoc(asoc);
             ...
             && rx[12]=='N' && rx[13]=='D')     // Bat3 Result F80 Remcap
     {
         ...
         quint8 rcc2=rx[8];
         int remcapac=((rcc1<<8)+rcc2);
         emit send_battery3_Maint_f80_remcap(remcapac);
             ...
             && rx[12]=='N' && rx[13]=='D')  // bat3 Result F80 Cycle Count
     {
         ...
         int ccount;
         ccount=((ccc1<<8)+ccc2);
         emit send_battery3_Maint_f80_cycount(ccount);
             ...
             && rx[12]=='N' && rx[13]=='D')    // Result F80 Temperature
     {
                        ...
                        float temperature=((temp1<<8)+temp2);
                        float temperatureGI =static_cast<float>(((temperature/10.0)-273.15));
                        emit send_battery3_Maint_f80_temperature(temperature);
             ...
             && rx[12]=='N' && rx[13]=='D')   // Bat 3 Result F80 Battery Status
     {
                         ...
                         quint8 bs2=rx[8];
                         int bstatus=((bs1<<8)+bs2);
                         emit send_battery3_Maint_f80_batstatus(bstatus);
             ...
             && rx[12]=='N' && rx[13]=='D')  // bat3 Result M10 Voltage
     {
         ...
         L=rx[8];
         v=((M<<8)+L);
        emit send_battery3_Maint_m10_voltage(v);
             ...
             && rx[11]=='E' && rx[12]=='N' && rx[13]=='D') // bat3 Result M10 ASOC
     {
         ...
         int asoc;
         asoc=rx[7];
         emit send_battery3_Maint_m10_asoc(asoc);
             ...
             && rx[12]=='N' && rx[13]=='D')     // bat3 Result M10 Remcap
     {
         ...
         quint8 rcc2=rx[8];
         int remcapac=((rcc1<<8)+rcc2);
         emit send_battery3_Maint_m10_remcap(remcapac);
             ...
             && rx[12]=='N' && rx[13]=='D')  // bat3 Result M10 Cycle Count
     {
         ...
         int ccount;
         ccount=((ccc1<<8)+ccc2);
         emit send_battery3_Maint_m10_cycount(ccount);
             ...
             && rx[12]=='N' && rx[13]=='D')    // Bat 3 Result M10 Temperature
     {
                        ...
                        float temperature=((temp1<<8)+temp2);
                        float temperatureGI =static_cast<float>(((temperature/10.0)-273.15));
                        emit send_battery3_Maint_m10_temperature(temperature);
             ...
             && rx[12]=='N' && rx[13]=='D')   // Bat 3 Result M10 Battery Status
     {
                         ...
                         quint8 bs2=rx[8];
                         int bstatus=((bs1<<8)+bs2);
                         emit send_battery3_Maint_m10_batstatus(bstatus);
             ...
             && rx[12]=='N' && rx[13]=='D')  // Bat 3 Result L80 Voltage
     {
         ...
         L=rx[8];
         v=((M<<8)+L);
        emit send_battery3_Maint_l80_voltage(v);
             ...
             && rx[11]=='E' && rx[12]=='N' && rx[13]=='D') // Bat 3 Result L80 ASOC
     {
         ...
         int asoc;
         asoc=rx[7];
         emit send_battery3_Maint_l80_asoc(asoc);
             ...
             && rx[12]=='N' && rx[13]=='D')     // Bat 3 Result L80 Remcap
     {
         ...
         quint8 rcc2=rx[8];
         int remcapac=((rcc1<<8)+rcc2);
         emit send_battery3_Maint_l80_remcap(remcapac);
             ...
             && rx[12]=='N' && rx[13]=='D')  // Bat 3 Result L80 Cycle Count
     {
         ...
         int ccount;
         ccount=((ccc1<<8)+ccc2);
         emit send_battery3_Maint_l80_cycount(ccount);
             ...
             && rx[12]=='N' && rx[13]=='D')    // Result L80 Temperature
     {
                        ...
                        float temperature=((temp1<<8)+temp2);
                        float temperatureGI =static_cast<float>(((temperature/10.0)-273.15));
                        emit send_battery3_Maint_l80_temperature(temperature);
             ...
             && rx[12]=='N' && rx[13]=='D')   // Bat 3 Result L80 Battery Status
     {
                         ...
                         quint8 bs2=rx[8];
                         int bstatus=((bs1<<8)+bs2);
                         emit send_battery3_Maint_l80_batstatus(bstatus);
             ...
             && rx[12]=='P' && rx[13]=='E'  )
     {
         ...
         L=rx[8];
         v=((M<<8)+L);
         emit send_bat3_update_voltage_maint(v);
             ...
             && rx[12]=='P' && rx[13]=='E'  )
     {
         ...
         a=rx[7];
         //  emit asocread(a);
         emit send_bat3_update_asoc_maint(a);
             ...
             && rx[12]=='P' && rx[13]=='E' )
     {
         ...
         t=static_cast<float>(((t1<<8)+t2));
         t=static_cast<float>(((t/10.0)-273.15));
         emit send_bat3_update_temp_maint(t);
             ...
             && rx[12]=='P' && rx[13]=='E'   )
     {
         ...
         r2=rx[8];
         r=((r1<<8)+r2);
         emit send_bat3_update_remcap_maint(r);
     ...
     emit send_bat3_update_cyccount_maint(c);
         // memset(rx_array,0,sizeof (rx_array));
             ...
             && rx[12]=='P' && rx[13]=='E'   )
     {
         ...
         bs2=rx[8];
         bstatus=((bs1<<8)+bs2);
         emit send_bat3_update_batstatus_maint(bstatus);
