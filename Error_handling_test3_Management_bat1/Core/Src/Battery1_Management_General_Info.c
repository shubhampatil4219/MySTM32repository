/*
 * Battery1_Management_General_Info.c
 *
...
// This function works
void Transmit_Bat1_Management_General_Info_to_Raspi()
{
	...
	// GI function starts From here
		...
		uint8_t send_serial_no[16]={'s','1','N','G','I','S','N','S',rx_serial_no[1],rx_serial_no[0],'S','N','G','I','E','e'};
		...
		//	y=y>>9;
		//	y=y+1980;
		uint8_t send_manuf_date[16]={'s','1','N','G','I','M','D','S',rx_manuf_date[1],rx_manuf_date[0],'M','D','G','I','E','e'};
		...
		uint8_t send_cyclecount[16]={'s','1','N','G','I','C','C','S',rx_cyclecount[1],rx_cyclecount[0],'C','C','G','I','E','e'};
		...
		uint8_t send_remain_capcacity[16]={'s','1','N','G','I','R','C','S',rx_remcapacity[1],rx_remcapacity[0],'R','C','G','I','E','e'};
	...
	//	printf("\nVolatge in main function = %d",vt);
		...
		uint8_t send[16]={'s','1','N','G','I','V','T','S',rx_voltage[1],rx_voltage[0],'V','T','G','I','E','e'};
		...
		uint8_t send_asoc[16]={'s','1','N','G','I','A','S','S',rx_asoc[0],'A','S','E','G','I','E','e'};
		...
		uint8_t send_temp[16]={'s','1','N','G','I','T','P','S',rx_temperature[1],rx_temperature[0],'T','P','G','I','E','e'};
		...
		uint8_t send_bat_status[16]={'s','1','N','G','I','B','S','S',rx_batstatus[1],rx_batstatus[0],'B','S','G','I','E','e'};
		...
		uint8_t send_bat_status2[16]={'s','1','N','G','I','B','S','S',rx_batstatus2[1],rx_batstatus2[0],'B','S','G','I','E','e'};
