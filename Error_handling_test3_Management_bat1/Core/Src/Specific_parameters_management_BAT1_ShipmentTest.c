/*
 * Specific_parameters_management_BAT1_ShipmentTest.c
 *
...
void Read_and_Compare_Specific_para_Bat1_Management_Shipment_Test_STM_to_Pi()
{
...
//	printf("Battery Status = %d\n",bs);
	...
	uint8_t send_specific_batstatus[16]={'s','1','N','S','I','B','S','S',rx_batstatus[1],rx_batstatus[0],'B','S','S','I','E','e'};
...
//	printf("Full Charge Capacity = %d\n",fcc);
	...
	uint8_t send_specific_fcc[16]={'s','1','N','S','I','F','C','S',rx_full_charge_capacity[1],rx_full_charge_capacity[0],'F','C','S','I','E','e'};
...
//	printf("Design Capacity = %d\n",designcap);
	...
	uint8_t send_specific_design_cap[16]={'s','1','N','S','I','D','C','S',rx_design_capacity[1],rx_design_capacity[0],'D','C','S','I','E','e'};
	...
	Compare_Specifi_para_Bat1_Management_Shipment_Test(fcc,designcap,bs);   // Function to compare specific parameters of battery 1
...
void Compare_Specifi_para_Bat1_Management_Shipment_Test(uint16_t fullchargecap , uint16_t designcap, uint16_t batterystatus)
{
	...
	{
		Bat1_Management_Shipment_testycycle_Autotestflag = false;   // // Abort the test
...
void Read_bat1_management_Run_time_to_empty_Shipment_Test_Cycle_start_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[16]={'s','1','N','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','F','I','E','e'};
...
void Read_bat1_management_Run_time_to_empty_Shipment_Test_Cycle_end_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[16]={'s','1','N','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','L','I','E','e'};
