...
uint8_t transmit_info_to_be_updated_bat2_maint[16];
...
// The above method of sending data to Pi didn't work properly.
		...
		transmit_info_to_be_updated_bat2_maint[0]='s';
		transmit_info_to_be_updated_bat2_maint[1]='2';
		transmit_info_to_be_updated_bat2_maint[2]='M';
		transmit_info_to_be_updated_bat2_maint[3]='U';
		transmit_info_to_be_updated_bat2_maint[4]='P';
		transmit_info_to_be_updated_bat2_maint[5]='V';
		transmit_info_to_be_updated_bat2_maint[6]='T';
		transmit_info_to_be_updated_bat2_maint[7]='S';
		transmit_info_to_be_updated_bat2_maint[8]=rx_geninfo_voltage[1];
		transmit_info_to_be_updated_bat2_maint[9]=rx_geninfo_voltage[0];
		transmit_info_to_be_updated_bat2_maint[10]='V';
		transmit_info_to_be_updated_bat2_maint[11]='T';
		transmit_info_to_be_updated_bat2_maint[12]='U';
		transmit_info_to_be_updated_bat2_maint[13]='P';
		transmit_info_to_be_updated_bat2_maint[14]='E';
		transmit_info_to_be_updated_bat2_maint[15]='e';




HAL_UART_Transmit_IT(&huart2, transmit_info_to_be_updated_bat2_maint, 16);
...
if(bat2_geninfo_asoc_flag==true)
{
	...
	transmit_info_to_be_updated_bat2_maint[3]='U';
	transmit_info_to_be_updated_bat2_maint[4]='P';
	transmit_info_to_be_updated_bat2_maint[5]='A';
	transmit_info_to_be_updated_bat2_maint[6]='S';
	transmit_info_to_be_updated_bat2_maint[7]='S';
	transmit_info_to_be_updated_bat2_maint[8]=rx_geninfo_asoc[0];
	transmit_info_to_be_updated_bat2_maint[9]='A';
	transmit_info_to_be_updated_bat2_maint[10]='S';
	transmit_info_to_be_updated_bat2_maint[11]='E';
	transmit_info_to_be_updated_bat2_maint[12]='U';
	transmit_info_to_be_updated_bat2_maint[13]='P';
	transmit_info_to_be_updated_bat2_maint[14]='E';
	transmit_info_to_be_updated_bat2_maint[15]='e';
...
//
		...
		transmit_info_to_be_updated_bat2_maint[3]='U';
		transmit_info_to_be_updated_bat2_maint[4]='P';
		transmit_info_to_be_updated_bat2_maint[5]='R';
		transmit_info_to_be_updated_bat2_maint[6]='C';
		transmit_info_to_be_updated_bat2_maint[7]='S';
		transmit_info_to_be_updated_bat2_maint[8]=rx_geninfo_remcap[1];
		transmit_info_to_be_updated_bat2_maint[9]=rx_geninfo_remcap[0];
		transmit_info_to_be_updated_bat2_maint[10]='R';
		transmit_info_to_be_updated_bat2_maint[11]='C';
		transmit_info_to_be_updated_bat2_maint[12]='U';
		transmit_info_to_be_updated_bat2_maint[13]='P';
		transmit_info_to_be_updated_bat2_maint[14]='E';
		transmit_info_to_be_updated_bat2_maint[15]='e';
...
void update_cyclecount_during_maintenance_bat2()
{
	 if(bat2_geninfo_cycle_flag==true)
	 {
		...
		transmit_info_to_be_updated_bat2_maint[6]='C';
		transmit_info_to_be_updated_bat2_maint[7]='S';
		transmit_info_to_be_updated_bat2_maint[8]=rx_cyclecount[1];
		transmit_info_to_be_updated_bat2_maint[9]=rx_cyclecount[0];
...
void update_batstatus_during_maintenance_bat2()
{
	 ...
	 if(bat2_geninfo_batterystatus_flag==true)
		 ...
		 bat2_geninfo_batterystatus_flag=false;
			...
			transmit_info_to_be_updated_bat2_maint[3]='U';
			transmit_info_to_be_updated_bat2_maint[4]='P';
			transmit_info_to_be_updated_bat2_maint[5]='B';
			transmit_info_to_be_updated_bat2_maint[6]='S';
			transmit_info_to_be_updated_bat2_maint[7]='S';
			transmit_info_to_be_updated_bat2_maint[8]=rx_batstatus[1];
			transmit_info_to_be_updated_bat2_maint[9]=rx_batstatus[0];
			transmit_info_to_be_updated_bat2_maint[10]='B';
			transmit_info_to_be_updated_bat2_maint[11]='S';
			transmit_info_to_be_updated_bat2_maint[12]='U';
			transmit_info_to_be_updated_bat2_maint[13]='P';
			transmit_info_to_be_updated_bat2_maint[14]='E';
			transmit_info_to_be_updated_bat2_maint[15]='e';
...
if(bat2_geninfo_temperature_flag==true)
{
	...
	bat2_geninfo_temperature_flag=false;
		...
		uint8_t tx_temp[1]={0x08}; // Temperature
				...
				transmit_info_to_be_updated_bat2_maint[6]='P';
				transmit_info_to_be_updated_bat2_maint[7]='S';
				transmit_info_to_be_updated_bat2_maint[8]=rx_temp[1];
				transmit_info_to_be_updated_bat2_maint[9]=rx_temp[0];
				transmit_info_to_be_updated_bat2_maint[10]='T';
				transmit_info_to_be_updated_bat2_maint[11]='P';
				transmit_info_to_be_updated_bat2_maint[12]='U';
				transmit_info_to_be_updated_bat2_maint[13]='P';
				transmit_info_to_be_updated_bat2_maint[14]='E';
				transmit_info_to_be_updated_bat2_maint[15]='e';
...
void update_current_during_maintenance_bat2() //0x0A
{
		...
		if(bat2_geninfo_current_flag==true)
		{
			...
			HAL_Delay(5);
//			uint16_t Bat1_Current_Maint_GI = rx_geninfo_current[1];
//			Bat1_Current_Maint_GI = Bat1_Current_Maint_GI << 8;
//			Bat1_Current_Maint_GI = Bat1_Current_Maint_GI + rx_geninfo_current[0];
	...
	//
		...
		//	uint8_t transmit_voltage[14];
			...
			transmit_info_to_be_updated_bat2_maint[4]='P';
			transmit_info_to_be_updated_bat2_maint[5]='C';
			transmit_info_to_be_updated_bat2_maint[6]='R';
			transmit_info_to_be_updated_bat2_maint[7]='S';
			transmit_info_to_be_updated_bat2_maint[8]=rx_geninfo_current[1];
			transmit_info_to_be_updated_bat2_maint[9]=rx_geninfo_current[0];
			transmit_info_to_be_updated_bat2_maint[10]='C';
			transmit_info_to_be_updated_bat2_maint[11]='R';
			transmit_info_to_be_updated_bat2_maint[12]='U';
			transmit_info_to_be_updated_bat2_maint[13]='P';
			transmit_info_to_be_updated_bat2_maint[14]='E';
			transmit_info_to_be_updated_bat2_maint[15]='e';
