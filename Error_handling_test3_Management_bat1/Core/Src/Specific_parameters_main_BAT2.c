...
//	printf("Battery Status = %d\n",bs);
	...
	uint8_t send_specific_batstatus[16]={'s','2','M','S','I','B','S','S',rx_batstatus[1],rx_batstatus[0],'B','S','S','I','E','e'};
...
//	printf("Full Charge Capacity = %d\n",fcc);
	...
	uint8_t send_specific_fcc[16]={'s','2','M','S','I','F','C','S',rx_full_charge_capacity[1],rx_full_charge_capacity[0],'F','C','S','I','E','e'};
...
//	printf("Design Capacity = %d\n",designcap);
	...
	uint8_t send_specific_design_cap[16]={'s','2','M','S','I','D','C','S',rx_design_capacity[1],rx_design_capacity[0],'D','C','S','I','E','e'};
...
void Read_bat2_maint_Run_time_to_empty_start_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[16]={'s','2','M','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','F','I','E','e'};
...
void Read_bat2_maint_Run_time_to_empty_end_of_discharge()
{
	...
	rte = rte << 8;
	rte = rte + rx_rte[0];
	uint8_t send_specific_rte[16]={'s','2','M','S','I','R','T','S',rx_rte[1],rx_rte[0],'R','T','L','I','E','e'};
