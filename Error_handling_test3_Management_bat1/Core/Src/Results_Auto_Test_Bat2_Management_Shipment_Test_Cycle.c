/*
 * Results_Auto_Test_Bat2_Management_Shipment_Test_Cycle.c
 *
...
void Read_Bat2_Management_Shipment_autotest_result_first_80_percent()
{
...
//
			...
			HAL_Delay(5);
			uint8_t send_cycount[16]={'s','2','N','R','F','8','C','C',rx_cyclecount[1],rx_cyclecount[0],'C','C','E','N','D','e'};
...
//
			...
			HAL_Delay(5);
			uint8_t send_remcap[16]={'s','2','N','R','F','8','R','C',rx_remcapacity[1],rx_remcapacity[0],'R','C','E','N','D','e'};
...
//			// ASOC
			...
			HAL_Delay(5);
			uint8_t send_asoc[16]={'s','2','N','R','F','8','A','S',rx_asoc[0],'A','S','E','E','N','D','e'};
			...
			HAL_Delay(5);
			uint8_t send_voltage[16]={'s','2','N','R','F','8','V','T',rx_voltage[1],rx_voltage[0],'V','T','E','N','D','e'};
			...
			HAL_Delay(5);
			uint8_t send_temp[16]={'s','2','N','R','F','8','T','P',rx_temperature[1],rx_temperature[0],'T','P','E','N','D','e'};
...
//
			...
			HAL_Delay(5);
			uint8_t send_battery_status[16]={'s','2','N','R','F','8','B','S',rx_batstatus[1],rx_batstatus[0],'B','S','E','N','D','e'};
...
void Read_Bat2_Management_Shipment_autotest_result_middle_10_percent()
{
...
//
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_cyclecount, 2);
			HAL_Delay(5);
			uint8_t send_cycount[16]={'s','2','N','R','M','1','C','C',rx_cyclecount[1],rx_cyclecount[0],'C','C','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_cycount, 16);
//
//
//
...
//
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_remcapacity, 2);
			HAL_Delay(5);
			uint8_t send_remcap[16]={'s','2','N','R','M','1','R','C',rx_remcapacity[1],rx_remcapacity[0],'R','C','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_remcap, 16);
//
//
//			// Remaining Capacity
...
//			// ASOC
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_asoc, 1);
			HAL_Delay(5);
			uint8_t send_asoc[16]={'s','2','N','R','M','1','A','S',rx_asoc[0],'A','S','E','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_asoc, 16);
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_voltage, 2);
			HAL_Delay(5);
			uint8_t send_voltage[16]={'s','2','N','R','M','1','V','T',rx_voltage[1],rx_voltage[0],'V','T','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_voltage, 16);
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_temperature, 2);
			HAL_Delay(5);
			uint8_t send_temp[16]={'s','2','N','R','M','1','T','P',rx_temperature[1],rx_temperature[0],'T','P','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_temp, 16);
//
//
//			// Temperature
...
//
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_batstatus, 2);
			HAL_Delay(5);
			uint8_t send_battery_status[16]={'s','2','N','R','M','1','B','S',rx_batstatus[1],rx_batstatus[0],'B','S','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_battery_status, 16);
			HAL_Delay(1);
			HAL_UART_Transmit_IT(&huart2, send_battery_status, 16);  // Transmitted 2 times because data was not
...
void Read_Bat2_Management_Shipment_autotest_result_last_80_percent()
{
...
//
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_cyclecount, 2);
			HAL_Delay(5);
			uint8_t send_cycount[16]={'s','2','N','R','L','8','C','C',rx_cyclecount[1],rx_cyclecount[0],'C','C','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_cycount, 16);
//
//
//
...
//
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_remcapacity, 2);
			HAL_Delay(5);
			uint8_t send_remcap[16]={'s','2','N','R','L','8','R','C',rx_remcapacity[1],rx_remcapacity[0],'R','C','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_remcap, 16);
//
//
//			// Remaining Capacity
...
//			// ASOC
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_asoc, 1);
			HAL_Delay(5);
			uint8_t send_asoc[16]={'s','2','N','R','L','8','A','S',rx_asoc[0],'A','S','E','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_asoc, 16);
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_voltage, 2);
			HAL_Delay(5);
			uint8_t send_voltage[16]={'s','2','N','R','L','8','V','T',rx_voltage[1],rx_voltage[0],'V','T','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_voltage, 16);
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_temperature, 2);
			HAL_Delay(5);
			uint8_t send_temp[16]={'s','2','N','R','L','8','T','P',rx_temperature[1],rx_temperature[0],'T','P','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_temp, 16);
//
//
//			// Temperature
...
//
			...
			HAL_I2C_Master_Receive_IT(&hi2c2, 0x16, rx_batstatus, 2);
			HAL_Delay(5);
			uint8_t send_battery_status[16]={'s','2','N','R','L','8','B','S',rx_batstatus[1],rx_batstatus[0],'B','S','E','N','D','e'};
			HAL_UART_Transmit_IT(&huart2, send_battery_status, 16);
			HAL_Delay(1);
			HAL_UART_Transmit_IT(&huart2, send_battery_status, 16);  // Transmitted 2 times because data was not
																	 // received correctly first time
