...
extern bool _bat2timerfunc_Start_Stop ;	// Flag to start and stop the wait time
extern uint16_t _bat2_counter_var;	//   Variable as a counter
extern bool _bat2_15min_wait_over;

extern bool _bat3timerfunc_Start_Stop ;	// Flag to start and stop the wait time
...
//	if(_bat2timerfunc_Start_Stop==true)
//	{
//		_bat2_counter_var++;
...
//	}
//
//	if(_bat3timerfunc_Start_Stop==true)
//		{
//			_bat3_counter_var++;
